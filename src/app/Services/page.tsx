    ...
    <>
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-16 md:mb-20">
          <div className="flex items-center space-x-2 sm:space-x-3 sm:space-x-4 p-4 sm:p-5 bg-gray-800 rounded-lg sm:rounded-xl shadow-lg card-lift border border-gray-700 hover:border-blue-500">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 sm:space-x-4 p-4 sm:p-5 bg-gray-800 rounded-lg sm:rounded-xl shadow-lg card-lift border border-gray-700 hover:border-purple-500">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 sm:space-x-4 p-4 sm:p-5 bg-gray-800 rounded-lg sm:rounded-xl shadow-lg card-lift border border-gray-700 hover:border-green-500">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          ...
          {/* Web Design Card */}
          <div className="group bg-gray-800 rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 card-lift border border-gray-700 hover:border-pink-500" data-aos="fade-up" data-aos-duration="500" data-aos-delay="50">
          ...
          <div className="group bg-gray-800 rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 card-lift border border-gray-700 hover:border-teal-500" data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
          ...
          <div className="group bg-gray-800 rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 card-lift border border-gray-700 hover:border-green-500" data-aos="fade-up" data-aos-duration="500" data-aos-delay="150">
          ...
          {/* AI Automation Card */}
          <div className="group bg-gray-800 rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 card-lift border border-gray-700 hover:border-emerald-500" data-aos="fade-up" data-aos-duration="500" data-aos-delay="200">
          ...
          <div className="group bg-gray-800 rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 card-lift border border-gray-700 hover:border-purple-500" data-aos="fade-up" data-aos-duration="500" data-aos-delay="250">
          ...
          {/* Canva Design Card */}
          <div className="group bg-gray-800 rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 card-lift border border-gray-700 hover:border-blue-500" data-aos="fade-up" data-aos-duration="500" data-aos-delay="300">
            <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto flex items-center justify-center rounded-full bg-gradient-to-br from-blue-400 to-blue-600 text-white keep-white mb-4 sm:mb-6 shadow-lg transform transition-all duration-300 group-hover:rotate-12 group-hover:scale-110">
