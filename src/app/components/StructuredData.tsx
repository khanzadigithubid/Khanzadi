...
const websiteSchema = {
  '@context': 'https://schema.org',
  '@type': 'WebSite',
  name: 'Khanzadi Wazir Ali Portfolio',
  url: 'https://khanzadi.vercel.app',
  description: 'Professional portfolio of Khanzadi Wazir Ali - AI Engineer and Full Stack Developer specializing in Next.js, React, TypeScript, Python, FastAPI, PostgreSQL, Shopify, and AI automation.',
  inLanguage: ['en', 'ur', 'ar', 'es'],
